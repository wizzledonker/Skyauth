...
public class CommandsExecutor implements CommandExecutor {
        ...
        public CommandsExecutor(AuthPlugin pdlugin) {
            this.plugin = pdlugin;
        }
						    				...
						    				player.getInventory().removeItem(ie);
                                                                        ...
                                                                        if (AuthPlugin.firstLogon.contains(playername)) {
                                                                            ...
                                                                            if (AuthPlugin.config.GiveKit) {
                                                                                for (ItemStack item : Utils.getFirstJoinKit()) {
                                                                                    inv.addItem(item);
                                                                                }
                                                                            ...
                                                                            AuthPlugin.firstLogon.remove(playername);
                                                                        }
							...
							if(!AuthPlugin.isLogged(player)) {
								if(args[0].equals(args[1])) {
									...
									player.sendMessage(message);
                                                                        AuthPlugin.firstLogon.add(playername);
								}
								else {
